...
from ImportFromGit.support import check_syntax_error
import inspect
import unittest
import sys
# testing import *
...
import ImportFromGit.ann_module as ann_module
import typing
from collections import ChainMap
from ImportFromGit import ann_module2
...
class GrammarTests(unittest.TestCase):
    ...
    def test_var_annot_module_semantics(self):
        with self.assertRaises(AttributeError):
            print(ImportFromGit.__annotations__)
    ...
    def test_var_annot_in_module(self):
        ...
        from ImportFromGit.ann_module3 import f_bad_ann, g_bad_ann, D_bad_ann
        with self.assertRaises(NameError):
            f_bad_ann()
        with self.assertRaises(NameError):
            g_bad_ann()
